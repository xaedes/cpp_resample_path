...
![build status linux docker ubuntu focal x64 release](https://web.martin-huenermund.de/cistatus/xaedes/cpp_resample_path/x64_ubuntu_focal_dRelease_status.svg)
